...
* Install according to ipSAE docs.
* Check:https://github.com/DunbrackLab/IPSAE
...
* `run_all_teams.py` to score many teams at once.(for organizing team)
...
You also need a reference native complex PDB for DockQ in Challenge 1, for example `native_complex.pdb`( this is the native complex) in the repo root.
...
&& ^
python scripts\run_team_folder.py ...Challenge2...
```
